...
export declare class HyperFormula implements TypedEmitter {
     ...
     * @category Helpers
     */
    simpleCellAddressToString(cellAddress: SimpleCellAddress, optionsOrContextSheetId?: {
     ...
     * @category Helpers
     */
    simpleCellRangeToString(cellRange: SimpleCellRange, optionsOrContextSheetId?: {
        includeSheetName?: boolean;
    } | number): string | undefined;
    /**
