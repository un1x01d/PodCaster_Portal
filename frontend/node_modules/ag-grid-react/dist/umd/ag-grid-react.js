...
var HeaderRowContainerComp = ({ pinned }) => {
  ...
  const setRef2 = (0, import_react12.useCallback)((eRef) => {
    ...
    headerRowCtrlRef.current = context.createBean(new import_ag_grid_community12.HeaderRowContainerCtrl(pinned));
    const compProxy = {
      setDisplayed,
...
var GridHeaderComp = () => {
  ...
  const setRef2 = (0, import_react13.useCallback)((eRef) => {
    ...
    gridCtrlRef.current = context.createBean(new import_ag_grid_community13.GridHeaderCtrl());
    const compProxy = {
      toggleCss: (name, on) => setCssClasses((prev) => prev.setClass(name, on)),
...
var CellComp = ({
      ...
      const addComp = (comp) => {
        if (comp) {
          ...
          cellWrapperDestroyFuncs.current.push(() => {
            (0, import_ag_grid_community16._removeFromParent)(comp.getGui());
            context.destroyBean(comp);
  ...
  const init = (0, import_react20.useCallback)(() => {
    ...
    compBean.current = context.createBean(new import_ag_grid_community16._EmptyBean());
    const compProxy = {
      toggleCss: (name, on) => cssManager.current.toggleCss(name, on),
      setUserStyles: (styles) => setUserStyles(styles),
