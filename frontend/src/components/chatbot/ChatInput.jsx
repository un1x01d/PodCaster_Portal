    ...
    return (
        ...
        >
            <div className="flex gap-1.5">
                <input
                    ref={inputRef}
                    className="flex-1 bg-slate-50 border border-slate-200 rounded-lg px-2 py-1 text-[11px] focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all placeholder-slate-400 text-slate-700 font-semibold tracking-[0.01em]"
