...
export const BUNDLE_AI_PRICING = {
  core: { openaiModel: "gpt-5", openaiInputCostPer1M: 0.05, openaiOutputCostPer1M: 0.40 },
  growth: { openaiModel: "gpt-5", openaiInputCostPer1M: 0.05, openaiOutputCostPer1M: 0.40 },
  enterprise: { openaiModel: "gpt-5", openaiInputCostPer1M: 0.05, openaiOutputCostPer1M: 0.40 },
};
export const AI_MODEL_PRICING = {
  "gpt-5": { openaiInputCostPer1M: 1.25, openaiOutputCostPer1M: 10.00 },
  "gpt-5-mini": { openaiInputCostPer1M: 0.25, openaiOutputCostPer1M: 2.00 },
...
export const BUSINESS_CLASSIFICATION_RUNTIME_DEFAULTS = {
  ...
  businessClassificationModel: "gpt-5",
...
export const AI_PROVIDER_CONFIG_DEFAULTS = {
  openai: { model: "gpt-5", baseUrl: "https://api.openai.com/v1", inputCostPer1M: 0.05, outputCostPer1M: 0.40 },
...
export const AI_RUNTIME_PRESETS = {
  micro: {
    ...
    translationOpenaiModel: "gpt-5",
    insightAiModel: "gpt-5",
