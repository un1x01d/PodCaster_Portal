...
export const DASHBOARD_COPY_EN = {
  ...
  signOut: "Sign out",
  language: "Language",
  dashboardOverview: "Client Views Overview",
  dashboardSubtitle: "Common metrics and portal state for {user}.",
  ...
  insightFeed: "Visual Summary Feed",
  automaticInsights: "Visual summaries of governed data",
  settings: "Settings",
  ...
  loadingInsights: "Loading visual summaries...",
  noInsightsYet: "No visual summaries yet for this sheet.",
  needsAttention: "Needs Attention",
  warning: "Warning",
  warningDown: "Warning Down",
  warningUp: "Warning Up",
  drivers: "Drivers",
  ...
  value: "Value",
  point: "Point",
  failedToLoadInsights: "Failed to load visual summaries",
  sheetTooLargeForInsights: "This sheet is too large for automatic visual summaries. Limit: {maxRows} rows.",
