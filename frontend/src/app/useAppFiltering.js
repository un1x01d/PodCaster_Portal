...
export function useAppFiltering(args) {
  const {
    API, token, sheetId, activeTab, headers, data, columnFilters, sortConfig,
    setColumnFilters, setUniqueValuesByColumn,
    setTrendsOn, setPivotOn, setTwoOn, setTrendsValueKey, setTrendsDateKey, setTrendGranularity, setPendingViewName,
    setPivotRowKey, setPivotValKey, setPivotColKey, setPivotAgg, primaryDlpMaskedColumns,
    compareYears, trendsDateKey
  } = args;
...
// Derived state
  ...
  return {
    displayHeaders, uniqueValuesByColumn, setUniqueValuesByColumn, fetchUniqueValues, sortedData, trendYearOptions, parseNum, resolveHeaderName, applyContainsFilter, applyChartConfig, saveInsightView
  };
}
